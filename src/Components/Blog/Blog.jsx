  ...
  return (
    <div className="Blog" id="blog">
      <div className="container">
        <h3 className="education-title">BLOG</h3>
        ...
        <div id="post-list" class="row">
          <div class="col-md-4">
            <div class="single-blog">
              <div class="blog-img">
                <img
                  src="http://themescare.com/demos/fabon-preview2/assets/img/blog-2.jpeg"
                  alt="blog"
                />
              ...
              <div class="blog-text">
                <h3>
                  <a href="#">The best tips of web design </a>
                </h3>
                <p>
          ...
          <div class="col-md-4">
            <div class="single-blog">
              ...
              <div class="blog-text">
                <h3>
                  <a href="#">Top budget hacks for your</a>
                </h3>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut
                  suscipit odio ante, id dapibus...
